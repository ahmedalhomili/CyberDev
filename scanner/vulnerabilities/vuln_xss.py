                ...
                try:
                    ...
                    if payload in response.text:
                         ...
                         if 'application/json' in content_type or 'text/plain' in content_type:
                             severity = "LOW"
                             desc = f"The application reflects user input in a non-HTML context ({content_type}). This is likely not exploitable XSS but indicates lack of output encoding."
                         else:
                             severity = "HIGH"
                             desc = f"The application reflects user input without sanitization in parameter '{param}'. Payload used: {payload}"
