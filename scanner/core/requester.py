...
class Requester:
    ...
    def get(self, url: str, params: Optional[dict] = None, headers: Optional[dict] = None, timeout: Optional[int] = None, allow_redirects: bool = True, **kwargs) -> requests.Response:
        """
    ...
    def post(self, url: str, data: Optional[dict] = None, json: Optional[dict] = None, headers: Optional[dict] = None, timeout: Optional[int] = None, allow_redirects: bool = True, **kwargs) -> requests.Response:
        """
